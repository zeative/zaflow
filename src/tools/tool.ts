import type { ToolConfig, ToolDefinition, ToolHandler } from '../types';
import type { z } from 'zod';

type DefineToolInput<T extends z.ZodType> = { name: string; description: string; schema: T; handler: ToolHandler<z.infer<T>>; config?: ToolConfig };
